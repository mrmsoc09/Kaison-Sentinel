...
from ..agents.agent_osint_graphqlmap import AgentOsintGraphqlmap
...
class OsintGraphqlGraphqlmap(ModuleBase):
    id = "osint.graphql.graphqlmap"
    kind = "recon"
    risk = "low"
