...
from ..agents.agent_osint_git_secrets import AgentOsintGitSecrets
...
class OsintSecretsGitSecrets(ModuleBase):
    id = "osint.secrets.git_secrets"
    kind = "recon"
    risk = "low"
