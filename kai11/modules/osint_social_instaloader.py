...
from ..agents.agent_osint_instaloader import AgentOsintInstaloader
...
class OsintSocialInstaloader(ModuleBase):
    id = "osint.social.instaloader"
    kind = "recon"
    risk = "low"
