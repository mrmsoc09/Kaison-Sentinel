...
from ..agents.agent_osint_osintframework import AgentOsintOsintframework
...
class OsintFrameworkOsintframework(ModuleBase):
    id = "osint.framework.osintframework"
    kind = "recon"
    risk = "low"
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        agent = AgentOsintOsintframework()
