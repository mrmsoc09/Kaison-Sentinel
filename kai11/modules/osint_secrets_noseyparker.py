...
from ..agents.agent_osint_noseyparker import AgentOsintNoseyparker
...
class OsintSecretsNoseyparker(ModuleBase):
    id = "osint.secrets.noseyparker"
    kind = "recon"
    risk = "low"
