...
from ..agents.agent_osint_assetfinder import AgentOsintAssetfinder
...
class OsintSubdomainAssetfinder(ModuleBase):
    id = "osint.subdomain.assetfinder"
    kind = "recon"
    risk = "low"
