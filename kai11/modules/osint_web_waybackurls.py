...
from ..agents.agent_osint_waybackurls import AgentOsintWaybackurls
...
class OsintWebWaybackurls(ModuleBase):
    id = "osint.web.waybackurls"
    kind = "recon"
    risk = "low"
