...
from ..agents.agent_osint_whatsmyname import AgentOsintWhatsmyname
...
class OsintFrameworkWhatsmyname(ModuleBase):
    id = "osint.framework.whatsmyname"
    kind = "recon"
    risk = "low"
