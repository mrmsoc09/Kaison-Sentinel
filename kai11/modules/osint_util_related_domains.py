...
from ..agents.agent_osint_related_domains import AgentOsintRelatedDomains
...
class OsintUtilRelatedDomains(ModuleBase):
    id = "osint.util.related_domains"
    kind = "recon"
    risk = "low"
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        agent = AgentOsintRelatedDomains()
