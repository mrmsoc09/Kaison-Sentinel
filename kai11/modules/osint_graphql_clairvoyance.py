...
from ..agents.agent_osint_clairvoyance import AgentOsintClairvoyance
...
class OsintGraphqlClairvoyance(ModuleBase):
    id = "osint.graphql.clairvoyance"
    kind = "recon"
    risk = "low"
