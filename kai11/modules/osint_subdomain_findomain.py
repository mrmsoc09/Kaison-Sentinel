...
from ..agents.agent_osint_findomain import AgentOsintFindomain
...
class OsintSubdomainFindomain(ModuleBase):
    id = "osint.subdomain.findomain"
    kind = "recon"
    risk = "low"
