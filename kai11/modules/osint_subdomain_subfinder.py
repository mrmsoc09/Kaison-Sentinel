...
from ..agents.agent_osint_subfinder import AgentOsintSubfinder
...
class OsintSubdomainSubfinder(ModuleBase):
    id = "osint.subdomain.subfinder"
    kind = "recon"
    risk = "low"
