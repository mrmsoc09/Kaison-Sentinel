...
from ..agents.agent_osint_pastehunter import AgentOsintPastehunter
...
class OsintPastePastehunter(ModuleBase):
    id = "osint.paste.pastehunter"
    kind = "recon"
    risk = "low"
