...
from ..agents.agent_osint_sublist3r import AgentOsintSublist3r
...
class OsintSubdomainSublist3r(ModuleBase):
    id = "osint.subdomain.sublist3r"
    kind = "recon"
    risk = "low"
