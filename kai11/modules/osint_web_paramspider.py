...
from ..agents.agent_osint_paramspider import AgentOsintParamspider
...
class OsintWebParamspider(ModuleBase):
    id = "osint.web.paramspider"
    kind = "recon"
    risk = "low"
