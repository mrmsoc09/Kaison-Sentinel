...
from ..agents.agent_osint_spiderfoot import AgentOsintSpiderfoot
...
class OsintFrameworkSpiderfoot(ModuleBase):
    id = "osint.framework.spiderfoot"
    kind = "recon"
    risk = "low"
