...
from ..agents.agent_osint_feroxbuster import AgentOsintFeroxbuster
...
class OsintContentFeroxbuster(ModuleBase):
    id = "osint.content.feroxbuster"
    kind = "recon"
    risk = "low"
