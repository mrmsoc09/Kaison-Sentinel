...
from ..agents.agent_osint_theharvester import AgentOsintTheharvester
...
class OsintFrameworkTheharvester(ModuleBase):
    id = "osint.framework.theharvester"
    kind = "recon"
    risk = "low"
