...
from ..agents.agent_osint_userrecon import AgentOsintUserrecon
...
class OsintFrameworkUserrecon(ModuleBase):
    id = "osint.framework.userrecon"
    kind = "recon"
    risk = "low"
