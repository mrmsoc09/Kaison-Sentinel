...
from ..agents.agent_osint_httpscreenshot import AgentOsintHttpscreenshot
...
class OsintVisualHttpscreenshot(ModuleBase):
    id = "osint.visual.httpscreenshot"
    kind = "recon"
    risk = "low"
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        agent = AgentOsintHttpscreenshot()
