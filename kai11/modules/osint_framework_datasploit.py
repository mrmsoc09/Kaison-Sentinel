...
from ..agents.agent_osint_datasploit import AgentOsintDatasploit
...
class OsintFrameworkDatasploit(ModuleBase):
    id = "osint.framework.datasploit"
    kind = "recon"
    risk = "low"
