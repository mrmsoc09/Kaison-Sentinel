...
from ..agents.agent_osint_secretfinder import AgentOsintSecretfinder
...
class OsintSecretsSecretfinder(ModuleBase):
    id = "osint.secrets.secretfinder"
    kind = "recon"
    risk = "low"
