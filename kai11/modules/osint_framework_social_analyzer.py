...
from ..agents.agent_osint_social_analyzer import AgentOsintSocialAnalyzer
...
class OsintFrameworkSocialAnalyzer(ModuleBase):
    id = "osint.framework.social_analyzer"
    kind = "recon"
    risk = "low"
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        agent = AgentOsintSocialAnalyzer()
