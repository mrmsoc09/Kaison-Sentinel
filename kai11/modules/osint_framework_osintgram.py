...
from ..agents.agent_osint_osintgram import AgentOsintOsintgram
...
class OsintFrameworkOsintgram(ModuleBase):
    id = "osint.framework.osintgram"
    kind = "recon"
    risk = "low"
