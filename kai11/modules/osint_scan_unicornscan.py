...
from ..agents.agent_osint_unicornscan import AgentOsintUnicornscan
...
class OsintScanUnicornscan(ModuleBase):
    id = "osint.scan.unicornscan"
    kind = "recon"
    risk = "low"
