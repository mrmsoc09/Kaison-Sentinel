...
from ..agents.agent_osint_cloudbrute import AgentOsintCloudbrute
...
class OsintCloudCloudbrute(ModuleBase):
    id = "osint.cloud.cloudbrute"
    kind = "recon"
    risk = "low"
