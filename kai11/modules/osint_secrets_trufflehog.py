...
from ..agents.agent_osint_trufflehog import AgentOsintTrufflehog
...
class OsintSecretsTrufflehog(ModuleBase):
    id = "osint.secrets.trufflehog"
    kind = "recon"
    risk = "low"
