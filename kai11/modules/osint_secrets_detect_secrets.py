...
from ..agents.agent_osint_detect_secrets import AgentOsintDetectSecrets
...
class OsintSecretsDetectSecrets(ModuleBase):
    id = "osint.secrets.detect_secrets"
    kind = "recon"
    risk = "low"
