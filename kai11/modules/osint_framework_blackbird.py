...
from ..agents.agent_osint_blackbird import AgentOsintBlackbird
...
class OsintFrameworkBlackbird(ModuleBase):
    id = "osint.framework.blackbird"
    kind = "recon"
    risk = "low"
