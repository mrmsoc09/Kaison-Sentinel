...
from ..agents.agent_osint_eyewitness import AgentOsintEyewitness
...
class OsintVisualEyewitness(ModuleBase):
    id = "osint.visual.eyewitness"
    kind = "recon"
    risk = "low"
