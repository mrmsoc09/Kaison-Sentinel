...
from ..agents.agent_osint_screenshoteer import AgentOsintScreenshoteer
...
class OsintVisualScreenshoteer(ModuleBase):
    id = "osint.visual.screenshoteer"
    kind = "recon"
    risk = "low"
