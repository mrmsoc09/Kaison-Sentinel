...
from ..agents.agent_osint_fingerprintx import AgentOsintFingerprintx
...
class OsintTechFingerprintx(ModuleBase):
    id = "osint.tech.fingerprintx"
    kind = "recon"
    risk = "low"
